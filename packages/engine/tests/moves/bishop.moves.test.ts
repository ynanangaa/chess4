...
describe('Bishop pseudo legal moves', () => {
  test('moves diagonally on an empty area', () => {
    ...
    const fromBishop = 90;
    const board = new Board([[bishop], [fromBishop]]);

    const moves = bishopMoves(bishop, fromBishop, board).map(pos => parseSquareCoords(pos));
  ...
  test('stops before a friendly piece', () => {
    ...
    const fromBishop = 90;
    const board = new Board([[bishop, ally], [fromBishop, 60]]);
  ...
  test('captures an enemy piece and stops there', () => {
    ...
    const fromBishop = 90;
    const board = new Board([[bishop, enemy], [fromBishop, 60]]);
