...
import { rookMoves } from '../../src/moves/rook-moves';
import { buildDuplicatePiece, buildPawn } from "../../src/utils/utils";
...
describe("Rook pseudo legal moves", () => {
    ...
    test("moves freely on an empty area", () => {
        ...
        const fromRook = 90;
        const board = new Board([[rook], [fromRook]]);

        const moves = rookMoves(rook, fromRook, board).map(pos => parseSquareCoords(pos));
    ...
    test("friendly piece blocks movement", () => {
        ...
        const fromRook = 90;
        const board = new Board([[rook, ally], [fromRook, 93]]);
    ...
    test("enemy piece can be captured", () => {
        ...
        const fromRook = 90;
        const board = new Board([[rook, enemy], [fromRook, 93]]);
